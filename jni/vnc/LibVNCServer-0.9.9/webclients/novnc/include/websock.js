...
function ZrleInStream() {
    var rQ = [], rQi = 0, rQmax = 10000;
    ...
    function rQwait(msg, num, goback) 
    {
        ...
        //Util.Debug("get msg"+msg+ "data:"+rQslice(rQi, num));
        return false;
    }
}
...
function open(uri, protocols) {
    console.log("<<<<<WebSock===open==uri:"+uri);
